package com.imooc.net.programming.nio.filecopy;
...
//            target.delete();
    ...
    public static void main(String[] args) {
        ...
        File smallFile = new File("D:/Videos/技术视频/07kafka/kafka.mp4");
        File smallFileCopy = new File("D:/Desktop/s30/1.mp4");
        ...
        benchmark(nioTransferCopy, smallFile, smallFileCopy);//0.7s
